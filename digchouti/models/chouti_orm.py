...
ENGINE = create_engine("mysql+pymysql://root:root@127.0.0.1:3306/digchouti?charset=utf8", max_overflow=5)
...
class News(Base):
    ...
    # 点赞个数，每次有人点赞就自加1，避免从favor表获得并计算点赞数
    # 与favor表的数据其实是有冗余的
    # 即便如此，在这里也是合理的，
    # 新闻观看的人多，点赞的人很少
    # 如果数据不冗余，则每次都要从数据库取两次，效率较低
